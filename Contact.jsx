...
export default function Contact() {
  return (
    <div className="flex gap-4 flex-col md:flex-row justify-center items-center min-h-screen bg-gray-100 p-4 ">
      <motion.div
        className="bg-primary text-background   p-8 rounded-lg shadow-lg w-full md:w-1/2 lg:w-1/2 m-2"
        initial={{ x: "100vw" }}
        animate={{ x: 0 }}
      ...
      <motion.div
        className=" p-10 rounded-lg shadow-lg w-full md:w-1/2 lg:w-1/2 m-2"
        initial={{ x: "-100vw" }}
        animate={{ x: 0 }}
