...
const NextArrow = (props) => {
  ...
  return (
    <div
      className="absolute right-2 md:right-0 top-1/2 transform -translate-y-1/2 z-10"
      onClick={onClick}
    >
...
const PrevArrow = (props) => {
  ...
  return (
    <div
      className="absolute left-2 md:left-0 top-1/2 transform -translate-y-1/2 z-10"
      onClick={onClick}
    >
